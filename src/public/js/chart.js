...
(function (global, factory) {
  ...
  function _isPointInArea(point, area, margin) {
    ...
    return (
      !area ||
      (point && point.x > area.left - margin && point.x < area.right + margin && point.y > area.top - margin && point.y < area.bottom + margin)
    );
  }
  ...
  function scaleRangesChanged(meta) {
    ...
    const changed =
      _scaleRanges.xmin !== xScale.min || _scaleRanges.xmax !== xScale.max || _scaleRanges.ymin !== yScale.min || _scaleRanges.ymax !== yScale.max;
  ...
  class Tooltip extends Element {
    ...
    drawBody(pt, ctx, options) {
      ...
      xLinePadding =
        displayColors && bodyAlignForCalculation !== 'right' ? (bodyAlign === 'center' ? boxWidth / 2 + boxPadding : boxWidth + 2 + boxPadding) : 0;
